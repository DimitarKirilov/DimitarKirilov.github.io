...
// fetch(
// 	"https://github.com/QuickBase/interview-demos/blob/master/websystems/data/dataset1.json"
// )
...
jsonData.parks.forEach((park) => {
	if (park.image !== "") {
		...
		<div class="card-content">
			<h3 class="card-title">${park.title}</h3>
			<p class="card-text">${park.body}</p>
			<a class="card-button" href="${park.link}">${park.linkText}</a>
		</div>
	`;
